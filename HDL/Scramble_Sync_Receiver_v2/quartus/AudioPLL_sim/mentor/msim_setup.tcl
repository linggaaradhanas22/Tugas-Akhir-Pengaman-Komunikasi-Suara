...
# ----------------------------------------
# If AudioPLL is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2025.01.23.20:41:17
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/AudioPLL.vho"
}
